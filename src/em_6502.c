...
AddrModeType addr_mode_table[] = {
   ...
   {2,    "%1$s #%2$s%3$02X"},          // IMM
   {2,    "%1$s %2$s%3$02X"},           // ZP
   {2,    "%1$s %2$s%3$02X,X"},         // ZPX
   {2,    "%1$s %2$s%3$02X,Y"},         // ZPY
   {2,    "%1$s (%2$s%3$02X,X)"},       // INDX
   {2,    "%1$s (%2$s%3$02X),Y"},       // INDY
   {2,    "%1$s (%2$s%3$02X)"},         // IND
   {3,    "%1$s %2$s%4$02X%3$03X"},     // ABS
   {3,    "%1$s %2$s%4$02X%3$03X,X"},   // ABSX
   {3,    "%1$s %2$s%4$02X%3$03X,Y"},   // ABSY
   {3,    "%1$s (%2$s%4$02X%3$02X)"},   // IND16
   {3,    "%1$s (%2$s%4$02X%3$02X,X)"}, // IND1X
   {3,    "%1$s %2$s%3$02X,%4$s"}       // ZPR
};
